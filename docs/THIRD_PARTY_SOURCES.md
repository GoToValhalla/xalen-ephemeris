...
Target wrapper: `crates/xalen-python/src/vedic_extra.rs`
...
Target wrapper: `crates/xalen-python/src/presentation.rs`
...
Kerykeion is retained as a behavioral/rendering/fixed-star reference only for this package:
